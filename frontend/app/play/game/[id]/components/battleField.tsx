      ...
      <div className="flex items-center justify-center gap-24">
        ...
        <div>
          {enemySelectedCard ? (
            ...
            <div className="w-72 h-96 rounded-2xl border-4 border-dashed border-red-300/50 flex flex-col items-center justify-center bg-linear-to-br from-red-900/30 to-gray-900/30">
